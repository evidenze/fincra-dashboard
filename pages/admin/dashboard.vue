        ...
        <div class="col-md-8">
          <div class="mt-4 mb-5">
            <div class="d-flex justify-content-between mb-4">
              <p class="font-weight-bold align-self-center">Recent activities</p>
            </div>
              ...
              <div>
                <div v-for="transaction in transactions" :key="transaction.id">
                  <div class="d-flex w-100 justify-content-between">
                    <div class="d-flex">
                      <div v-if="transaction.type == 'credit'" class="dot align-self-center">
                      </div>
                      <div v-else class="dot-red align-self-center"></div>
                      <div class="ml-3">
                        <small class="font-weight-bold">&#8358;{{
              Intl.NumberFormat().format(transaction.amount) }}</small><br>
...
export default {
  ...
  async fetch() {
    let transactions = await this.$axios.get(`${this.$config.apiURL}/admin/transactions`);
    this.transactions = transactions.data.data.transactions.data;
